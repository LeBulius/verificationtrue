            ...
            <div className="p-3">
                <div className="flex mb-3">
                    <div className="flex-grow">
                        ...
                        <p>{`${id.slice(0, 8)}...${id.slice(id.length - 8)}`}</p>
                    </div>
                    <div className="flex mr-3">
                        <a target="_blank" className="text-blue-700" href={`https://polygonscan.com/address/${address}#tokentxnsErc721`}>{`${address.slice(0, 4)}...${address.slice(address.length - 4)}`}</a>
                    </div>
                </div>
